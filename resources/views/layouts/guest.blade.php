...
<head>
    ...
    <title>@yield('title', 'NusaWisata — Masuk atau Daftar')</title>
    ...
    <div class="auth-page">
        <div class="auth-container">
            <div class="auth-header">
                <a href="{{ route('home') }}" class="auth-brand" title="Kembali ke Beranda NusaWisata">
                    <img src="{{ asset('images/logo.png') }}" alt="NusaWisata">
                </a>
            </div>
