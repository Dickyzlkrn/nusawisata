...
@section('title', 'Tambah Provinsi Baru')
...
<div class="admin-page-header">
    <div>
        ...
        <p style="color: var(--color-text-muted); font-size: 14px;">Masukkan wilayah provinsi baru ke dalam sistem.</p>
    </div>
...
<div class="detail-card" style="max-width: 700px;">
    <form action="{{ route('admin.provinces.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-input @error('name') error @enderror" value="{{ old('name') }}" placeholder="Contoh: Papua Barat Daya" required>
            @error('name')
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-textarea" placeholder="Ringkasan potensi dan daya tarik wisata daerah...">{{ old('description') }}</textarea>
        </div>
        ...
        <div style="display: flex; gap: 12px; margin-top: 28px;">
            <button type="submit" class="btn-primary" style="border-radius: var(--radius-pill); padding: 12px 28px;">
                <i class="fa-solid fa-plus"></i> Simpan Provinsi
            </button>
